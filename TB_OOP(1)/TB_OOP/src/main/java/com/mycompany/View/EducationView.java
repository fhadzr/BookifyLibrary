 ...
 * @author asus
 */
public class EducationView extends javax.swing.JFrame {
    ...
    public final void getData() {
        ...
        dtm.setRowCount(0);
        String book_category = "education";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EducationView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
